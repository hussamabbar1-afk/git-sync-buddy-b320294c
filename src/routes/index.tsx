    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          "@type": "Organization",
          "@id": "https://zunftecho.de/#organization",
          name: "ZunftEcho",
          url: "https://zunftecho.de/",
          sameAs: ["https://www.youtube.com/channel/UCp_6QWMLCckl7rC9j_-ImqA"],
          address: {
            "@type": "PostalAddress",
      ...
      },
      {
        ...
        children: JSON.stringify({
          ...
          "@id": "https://zunftecho.de/#software",
          name: "ZunftEcho",
          url: "https://zunftecho.de/",
          ...
          provider: { "@id": "https://zunftecho.de/#organization" },
        }),
      },
      {
        type: "application/ld+json",
        children: JSON.stringify({
          ...
          inLanguage: "de-DE",
          publisher: { "@id": "https://zunftecho.de/#organization" },
        }),
      },
    ],
  }),
