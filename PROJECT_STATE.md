...
- أُجريت بروفة إنتاجية كاملة لمسار أول Pilot بطلب اصطناعي: نجح API، وحُفظت حقول التأهيل والمصدر،
  وسُجل نجاح تنبيه البريد بلا خطأ، ثم حُذف السجل وأثبتت إعادة الفحص بقاء صفر بيانات تجريبية. نُشرت
  `pilot-request` v8 لتضيف داخل التنبيه خطوة رد كتابية بلا مكالمة وSignal score داخليًا من 0–5
  لترتيب المراجعة فقط، لا للقبول الآلي. تقرير القبول في `docs/first-pilot-readiness-2026-09-06.md`.
...
- مسار أول استجابة أصبح جاهزًا ومختبرًا حيًا عبر `pilot-request` v8: التنبيه فوري وقابل للرد مباشرة،
  يوضح مهلة يوم عمل ومنع المكالمة، ويعرض أولوية داخلية غير ملزمة. الفوترة والدفع لم يتغيرا.
