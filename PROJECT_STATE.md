...
| YouTube-Markenkanal                    | مفعّل                     | حُفظت الهوية باسم ZunftEcho و`@zunftecho` والوصف والرابط والبريد الرسمي؛ رفع الفيديو ينتظر تفعيل وصول إضافة Chrome للملفات |
...
- حُفظت هوية قناة YouTube العامة باسم `ZunftEcho` والمعرّف `@zunftecho`، مع البريد الرسمي ورابط
  Demo قابل للقياس. تعذر رفع الفيديو من جلسة الأتمتة لأن إضافة Chrome لا تملك حاليًا
  `Allow access to file URLs`؛ ملف الرفع المضغوط محفوظ مؤقتًا محليًا ولا يُتعامل معه كنشر مكتمل.
...
- اكتملت هوية قناة YouTube وGoogle Search Console وDNS وSitemap. المتبقي خارجيًا هو رفع الفيديو
  الرسمي بعد تفعيل وصول إضافة Chrome إلى عناوين الملفات، ثم إنشاء Bing Webmaster إن اختيرت.
